...
-- Create a textclock widget
 -- TODO add more options in smenu
smenu = awful.menu({items = {{"Check for Updates", function (c) awful.util.spawn("gksudo '" .. smlterm .. " -e pacman -Sy'") vicious.force({syswidget}) end, nil}, -- FIXME force the widget after pacman
...
netwidget = blingbling.net({interface = nil, show_text = true, background_color = beautiful.colors.base0, text_color = beautiful.colors.base03, graph_color = beautiful.colors.base03, graph_line_color = "#00000000", graph_background_color = beautiful.colors.base2, background_text_color = "#00000000", font = "termsyn", font_size = "11"})
...
volume_master = blingbling.volume({height = 18, graph_color = beautiful.colors.base03, graph_background_color = "#3D4A4F", background_color = beautiful.colors.base1, width = 40, show_text = true, text_color = beautiful.colors.base03, background_text_color = "#00000000", bar = false, label ="$percent%"})
...
root.buttons(awful.util.table.join(
    ...
    awful.button({ modkey }, 5, awful.client.restore)
))
-- }}}
...
awful.rules.rules = {
    ...
    { rule_any = { class = {"Galculator", "pinentry", "Nitrogen", "Steam"}, instance = {"plugin-container", "exe"} },
      properties = { floating = true } },
    { rule_any = { class = { "Gnome-mplayer", "Gcolor2", "Mate-calc" }, instance = {"file_progress"} }, callback = function(c) add_titlebar(c) end,
      properties = { floating = true } },
}
-- }}}
